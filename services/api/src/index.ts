...
type Media={id:string;title:string;description:string;category:string;video_key:string;thumbnail_key:string|null;mime_type:string;created_at:string;kids_allowed:number}
