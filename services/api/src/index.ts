...
type Media={id:string;title:string;description:string;category:string;video_key:string;source_url:string|null;thumbnail_key:string|null;mime_type:string;created_at:string;kids_allowed:number;series_id:string|null;series_title:string|null;season_number:number|null;episode_number:number|null;release_date:string|null;year:number|null;genres:string;rating:string|null;duration_seconds:number|null;featured:number}
